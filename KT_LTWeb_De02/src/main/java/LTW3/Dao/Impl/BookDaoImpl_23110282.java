...
public class BookDaoImpl_23110282 implements BookDao_23110282 {

    // Lấy tất cả các sách
    @Override
	public List<BookModel_23110282> getAllBooks() {
        List<BookModel_23110282> books = new ArrayList<>();
